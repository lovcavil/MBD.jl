...
SIM_DIR = SCRIPT_DIR / "DATA" / "simvali_fl05"

scaling_dict = {
    "Strain@B1_1.RN_7": 0.339,
    "Strain@B2_1.RN_7": 0.3505,
    "Strain@B2_2.RN_7": 0.5762,
    "Strain@B2_3.RN_7": -0.5072,
    "Strain@B2_4.RN_7": 0.0763,
    "Strain@B3_1.RN_7": 0.8693,
    "Strain@B3_2.RN_7": 0.8576,
    "Strain@B3_3.RN_7": -0.2255,
    "Strain@B3_4.RN_7": 0.2455,
}
...
def build_plot_paths():
    return (
        EXPR_DIR / "MR_door (run 30)_out.csv",
        SIM_DIR / "req_KALKER_MID_F_clean.csv",
...
def main():
    ...
    # Parameters
    selected_columns1 = ["Strain@B3_2.RN_7"]#"Strain@B3_2.RN_1" Strain@B3_2.RN_6
    selected_columns2 = ["U3"]
    selected_columns5 = ["FY"]
    start_time1 = 62.1
    end_time1 = start_time1 + 2.0
    start_time2 = 0
    end_time2 = 2
    start_time3 = 0
    end_time3 = 1.46
    ...
    output_path = output_folder / "A20.compare_expr_sim_performance_simvali_fl05.png"
