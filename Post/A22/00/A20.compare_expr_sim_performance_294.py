...
def build_plot_paths():
    return (
        EXPR_DIR / "MR_door (run 29)_out.csv",
...
def main():
    ...
    # Parameters
    selected_columns1 = ["Strain@B3_2.RN_6"]#"Strain@B3_2.RN_1" Strain@B3_2.RN_6
    ...
    output_path = output_folder / "A20.compare_expr_sim_performance_294.png"
