...
SIM_DIR = SCRIPT_DIR / "DATA" / "sim316-1-60-nd"

CAN_COLUMN = "can@press.RN_8"
SIM_TIME_COL = "TIME"
SIM_PRESS_COL = "U2"
...
def main():
    expr_path = EXPR_DIR / "MR_door (run 31)_out.csv"
    ...
    output_path = output_folder / "expr_can_press_316.png"
