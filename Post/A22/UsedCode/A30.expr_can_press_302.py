...
SIM_DIR = SCRIPT_DIR / "DATA" / "sim302-1-60"

CAN_COLUMN = "can@press.RN_7"
SIM_TIME_COL = "TIME"
SIM_PRESS_COL = "U2"
...
def plot_can_pressure(ax, df: pd.DataFrame, start_time: float):
    ...
    ax.plot(
        ...
        color="navy",
        linestyle="-",
        label="Experiment: can@press.RN_7",
    )
...
def main():
    expr_path = EXPR_DIR / "MR_door (run 30)_out.csv"
    ...
    output_path = output_folder / "expr_can_press_302.png"
