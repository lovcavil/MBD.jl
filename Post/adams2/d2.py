...
def plot_all_columns_with_generated_time(fn, data_csv_file, output_folder, colors, line_styles, dpi):
    ...
    color_legend = ax.legend(handles=color_legend_handles, title='Contact Model', loc='upper left', bbox_to_anchor=(0, 1), prop={'family': 'Times New Roman', 'size': 16}, title_fontsize=16)
    style_legend = ax.legend(handles=style_legend_handles, title='Friction Model', loc='upper left', bbox_to_anchor=(.31, 1), prop={'family': 'Times New Roman', 'size': 16}, title_fontsize=16)
