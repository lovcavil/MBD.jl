...
def plot_all_columns_with_generated_time(fn, data_csv_file, output_folder, colors, line_styles, dpi):
    ...
    color_legend = ax.legend(handles=color_legend_handles, title='Contact Model', loc='upper left', bbox_to_anchor=(0.05, 1), prop={'family': 'Times New Roman', 'size': 16}, title_fontsize=16)
    style_legend = ax.legend(handles=style_legend_handles, title='Friction Model', loc='upper left', bbox_to_anchor=(.36, 1), prop={'family': 'Times New Roman', 'size': 16}, title_fontsize=16)
...
if __name__ == "__main__":
    ...
    data_csv_file = r"C:\OneDrive\Articles\10.Working\[D21][20211009]ContactMechanics\MBD.jl\plots\adams2\6\GFO_LG U4_export.csv"  # Replace with your actual data CSV file path
    output_folder = './plots/adams2/MGLG10'  # Replace with your desired output folder path
    run_plotting('LG', data_csv_file, output_folder, dpi=300)

    data_csv_file = r"C:\OneDrive\Articles\10.Working\[D21][20211009]ContactMechanics\MBD.jl\plots\adams2\6\GFO_LG U3_export.csv"  # Replace with your actual data CSV file path
    run_plotting('LG_Y', data_csv_file, output_folder, dpi=300)
    
    data_csv_file = r"C:\OneDrive\Articles\10.Working\[D21][20211009]ContactMechanics\MBD.jl\plots\adams2\6\GFO_MG U4_export.csv"  # Replace with your actual data CSV file path
    run_plotting('MG', data_csv_file, output_folder, dpi=300)

    data_csv_file = r"C:\OneDrive\Articles\10.Working\[D21][20211009]ContactMechanics\MBD.jl\plots\adams2\6\GFO_MG U3_export.csv"  # Replace with your actual data CSV file path
    run_plotting('MG_Y', data_csv_file, output_folder, dpi=300)
    
    # data_csv_file = r"C:\OneDrive\Articles\10.Working\[D21][20211009]ContactMechanics\MBD.jl\plots\adams2\6\GFO_MF U3_export.csv"  # Replace with your actual data CSV file path
    # run_plotting('MF', data_csv_file, output_folder, dpi=300)
    
    # data_csv_file = r"C:\OneDrive\Articles\10.Working\[D21][20211009]ContactMechanics\MBD.jl\plots\adams2\6\GFO_LF U3_export.csv"  # Replace with your actual data CSV file path
