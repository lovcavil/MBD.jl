...
def plot_all_columns_with_generated_time(fn, data_csv_file, output_folder, colors, line_styles, dpi):
    ...
    color_legend = ax.legend(handles=color_legend_handles, title='Contact Model', loc='upper left', bbox_to_anchor=(0, 0.45), prop={'family': 'Times New Roman', 'size': 16}, title_fontsize=16)
    style_legend = ax.legend(handles=style_legend_handles, title='Friction Model', loc='upper left', bbox_to_anchor=(.31, 0.3), prop={'family': 'Times New Roman', 'size': 16}, title_fontsize=16)
...
if __name__ == "__main__":
    ...
    data_csv_file = r"C:\OneDrive\Articles\10.Working\[D21][20211009]ContactMechanics\MBD.jl\plots\adams2\6\GFO_MR U3_export.csv"  # Replace with your actual data CSV file path
    output_folder = './plots/adams2/'  # Replace with your desired output folder path
    run_plotting('MR', data_csv_file, output_folder, dpi=300)

    # data_csv_file = r"C:\OneDrive\Articles\10.Working\[D21][20211009]ContactMechanics\MBD.jl\plots\adams2\6\GFO_LR U3_export.csv"  # Replace with your actual data CSV file path
    # run_plotting('LR', data_csv_file, output_folder, dpi=300)
