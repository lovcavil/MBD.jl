...
data = np.genfromtxt(r'C:\Users\lovca\OneDrive\Articles\10.Working\MBD.jl\MBD.jl\src\problem\GUIDE_M_A26MID_Report.csv', delimiter=',', skip_header=1)
x = data[:, 0]
y = data[:, 1]
...
plt.savefig('Figure1_XYCurveA26.png', dpi=600, bbox_inches='tight')
...
plt.savefig('Figure2_CurvatureA26.png', dpi=600, bbox_inches='tight')
