...
path2 = r"C:\Users\lovca\OneDrive\Articles\10.Working\MBD.jl\plots\adams2\7\request_ACC_door U2_export.csv"
...
window_sizes2 = [6] * len(selected_columns2)
#print(df1.columns)
print(df2.columns)
# Filter data
...
def create_figure(processed_data1, processed_data2, selected_columns1, selected_columns2):
    ...
    ax.plot(processed_data1['t_adj'], processed_data1['acc@A7_X.RN_6'], label=f'Experiment', color='k',linewidth=1, linestyle='--')
    ...
    output_path = os.path.join(script_dir, 'valiacc.png')
