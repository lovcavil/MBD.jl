...
col=[(138/256, 201/256, 38/256),
    "#C1121F","#003049"]
# Define paths
path1 = r"C:\Users\lovca\OneDrive\Articles\10.Working\MBD.jl\plots\adams2\MR_door (run 29)_out2.csv"
path2 = r"C:\Users\lovca\OneDrive\Articles\10.Working\MBD.jl\plots\adams2\7\request_ACC_door U3_export.csv"
...
# Define parameters
selected_columns1 = ['acc@A7_Y.RN_6',"t "]
start_time1 = 98.415
end_time1 = 99.930
...
processed_data1['acc@A7_Y.RN_6'] = processed_data1['acc@A7_Y.RN_6'] * (-9.8)
...
def create_figure(processed_data1, processed_data2, selected_columns1, selected_columns2):
    ...
    ax.plot(processed_data1['t_adj'], processed_data1['acc@A7_Y.RN_6'], label=f'Experiment', linestyle='--', color='k',linewidth=1)
    ax.plot(processed_data2['t_adj'], processed_data2['413.asc'], label=f'Simulation',color='k',linewidth=1)
    ax.set_xlabel("Time (s)")
    ax.set_ylabel("Acceleration in y direction (m/s²)", fontdict=textstyle)
    ...
    output_path = os.path.join(script_dir, 'valiaccy.png')
