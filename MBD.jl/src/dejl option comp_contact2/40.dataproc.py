...
# Example usage
folder_path = "C:/tmp/A16run\src\dejl option comp_contact2/s22"
output_excel = "C:/tmp/A16run\src\dejl option comp_contact2/s22.xlsx"  # replace with desired Excel output filename
