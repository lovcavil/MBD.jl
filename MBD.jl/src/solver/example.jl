...
function test_II1()
    ...
    # Integration
    sol = solve(prob, IDA(), reltol=1e-6, abstol=1e-6, progress=true,dtmin=0.00001)
...
function test_II3()
    ...
    # Integration
    sol = solve(prob, IDA(), reltol=1e-6, abstol=1e-6,progress=true)
...
function test2()
    ...
    # Application Data Function
    nb, ngc, nh, nc, NTSDA, SJDT, SMDT, STSDAT, q, qd = AppData_II7(305)
    par = Any[nb, ngc, nh, nc, g, 0, 0, h0, hvar, NTSDA]
