...
function AD(app)
    if app == 309  # model_door_309
        ...
        nh = 2 +2  #+7     # Number of holonomic constraints
        nhc = 10 +10  #+7    # Number of holonomic constraint equations
        ...
        # SJDT[:, 5] = Any[1070, 2, 0, si1pr5..., zer..., spl_dic["MF"], zer..., zer..., zer..., zer...]
    
        # fixrootrollerMR=json_data["fixrootrollerMR"]
        # si1pr6= fixrootrollerMR-rMA
        # SJDT[:, 6] = Any[1070, 2, 0, si1pr6..., zer..., spl_dic["MR"], zer..., zer..., zer..., zer...]
    
        # fixrootrollerLF=json_data["fixrootrollerLF"]
        # si1pr7= fixrootrollerLF-rLA
        # SJDT[:, 7] = Any[1070, 3, 0, si1pr7..., zer..., spl_dic["LF"], zer..., zer..., zer..., zer...]
    
        # fixrootrollerLR=json_data["fixrootrollerLR"]
        # si1pr8= fixrootrollerLR-rLA
        # SJDT[:, 8] = Any[1070, 3, 0, si1pr8..., zer..., spl_dic["LR"], zer..., zer..., zer..., zer...]
    
        # fixrootrollerU=json_data["fixrootrollerU"]
        # si1pr9= fixrootrollerU-rDoor
        # SJDT[:, 9] = Any[1070, 1, 0, si1pr9..., zer..., spl_dic["U"], zer..., zer..., zer..., zer...]
