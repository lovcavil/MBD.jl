...
function AD240(app,contact_json)
    if app >= 240 && app < 249
        ...
        nhc = 2*5 # Number of holonomic constraint equations
        ...
        SJDT[:, 1] = Any[4, 1, 0, si1pr1..., sj2pr1..., 0, ux..., uy..., ux..., uy...]#z
        #SJDT[:, 2] = Any[10, 1, 0, si1pr1..., sj2pr1..., 0, ux..., uz..., ux..., uz...]#z
        SJDT[:, 2] = Any[4, 1, 2, si1pr2..., sj2pr2..., 0, ux..., uy..., ux..., uy...]#z
        #SJDT[:, 3] = Any[4, 2, 3, si1pr3..., sj2pr3..., 0, ux..., uz..., ux..., uz...]#z

        #SMDT = hcat(json_data["SMDT"]["mass1"], json_data["SMDT"]["mass2"])
         
        SMDT = hcat(vcat(1.0, 10.E-03, 10.E-03, 10.E-03),
        vcat(1.0, 10.E-03, 10.E-03, 10.E-03),
